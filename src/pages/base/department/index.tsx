 ...
 * @LastEditTime: 2020-04-28 17:58:29
 */
...
class DepartmentPage extends React.Component<DepartmentPageProps> {
  private columns = [
    { title: '项目代码', dataIndex: 'departmentCode' },
    { title: '项目名称', dataIndex: 'departmentName' },
    { title: '联系人', dataIndex: 'contact' },
    { title: '联系电话', dataIndex: 'contactPhone' },
    { title: '组别', dataIndex: 'description' },
    { title: '开始时间', dataIndex: 'createdAt' },
    { title: '结束时间', dataIndex: 'updatedAt' },
    {
      title: '操作',
    ...
    return (
      <>
        ...
        <React.Suspense fallback={<Loading />}>
          <CommonModal
            title={!!this.props.department ? '修改项目' : '新增项目'}
